...
//	하지만 이 경우 private 멤버 변수들의 접근이 가능한 getter나 setter를 남겨야 하고, 
//	따라서 이 방법으로 접근이 가능한가? 에 대해 애매하다. 
...
/* ************************************************************************** */
	 ...
	 * 
	 * @param val 0 이면 sign, 1 이면 execute 권한을 확인받는다. 
	 * @return Grade 
	 */
