...
/*   Updated: 2022/07/07 23:10:19 by haryu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

static void	try_thought(t_common *pub, t_person *man, int *fork)
{
	printf_action(3, get_ms() - pub->dining_time, man->id, pub->print);
	while (TRUE)
	{
