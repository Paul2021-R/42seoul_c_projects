...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/11 17:54:47 by trofidal          #+#    #+#             */
/*   Updated: 2021/10/11 18:35:31 by trofidal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
    std::string fN = "lstadd_front"; //Function Name
    Infos   trofidal(fN, 3);
    ...
    ft_lstadd_front(&lst, ft_lstnew((void *)42));
    ...
    ft_lstadd_front(&lst, ft_lstnew((void *)24));
    retA = (lst->content == (void *)24 && lst->next->content == (void *)42) ? 1 : 0;
    retB = lst->next->next == 0 ? 1 : 0;
    /*2*/trofidal.t(fN, "&lst, ft_lstnew((void *)24)");trofidal.tIntLst(retA, retB);
    trofidal.tripouilleCheck(lst, sizeof(t_list));
    ft_lstadd_front(&lst, ft_lstnew((void *)69420));
    retA = (lst->next->next->content == (void *)42 && lst->content == (void *)69420) ? 1 : 0;
